...
if game.CoreGui:FindFirstChild("Negativez Ware") then
    game.CoreGui:FindFirstChild("Negativez Ware"):Destroy()
end

ScreenGui.ZIndexBehavior = Enum.ZIndexBehavior.Global;
ScreenGui.Name = "Negativez Ware"
...
function Library:UpdateDependencyBoxes() -- Update
...
do
    ...
    function Funcs:AddText(Text, Mid)
        local Label = {};
...
function Library:CreateWindow(WindowTitle)
    ...
    function Window:AddTab(Name)
        ...
        function Tab:AddCenter(Info)
            local Groupbox = {};

            local BoxOuter = Library:Create('Frame', {
                BackgroundColor3 = Library.BackgroundColor;
                BorderColor3 = Library.InlineColor;
                Size = UDim2.new(1000, 1000, 1000, 1000);
                ZIndex = 2;
                Parent = Info.Side == "Center" and LeftSide or RightSide;
            });
        ...
        function Tab:AddCenterGroupBox(Name)
            return Tab:AddCenter({ Side = "Center"; Name = Name; });
        end;
