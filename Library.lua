...
local Library = game.CoreGui:FindFirstChild("Linoria-Negativez") -- Add
...
ScreenGui.Name = "Linoria-Negativez"
...
local Library = {
    ...
    AccentColor = Color3.fromRGB(3, 252, 240);
    OutlineColor = Color3.fromRGB(0, 0, 5);
    RiskColor = Color3.fromRGB(10, 30, 40),
...
function Library:CreateWindow(Label)
